...
*Defined in [data/input.ts:14](https://github.com/iotaeco/iota-pico-data/blob/0635260/src/data/input.ts#L14)*
...
*Defined in [data/input.ts:26](https://github.com/iotaeco/iota-pico-data/blob/0635260/src/data/input.ts#L26)*
...
*Defined in [data/input.ts:22](https://github.com/iotaeco/iota-pico-data/blob/0635260/src/data/input.ts#L22)*
...
*Defined in [data/input.ts:18](https://github.com/iotaeco/iota-pico-data/blob/0635260/src/data/input.ts#L18)*
...
*Defined in [data/input.ts:40](https://github.com/iotaeco/iota-pico-data/blob/0635260/src/data/input.ts#L40)*
