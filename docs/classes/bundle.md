...
*Defined in [data/bundle.ts:21](https://github.com/iotaeco/iota-pico-data/blob/5656943/src/data/bundle.ts#L21)*
...
*Defined in [data/bundle.ts:17](https://github.com/iotaeco/iota-pico-data/blob/5656943/src/data/bundle.ts#L17)*
...
*Defined in [data/bundle.ts:51](https://github.com/iotaeco/iota-pico-data/blob/5656943/src/data/bundle.ts#L51)*
...
*Defined in [data/bundle.ts:38](https://github.com/iotaeco/iota-pico-data/blob/5656943/src/data/bundle.ts#L38)*
